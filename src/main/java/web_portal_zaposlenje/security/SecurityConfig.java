package web_portal_zaposlenje.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/images/**", "/webjars/**", "/styles.css", "/korisnik-detalji-styles.css").permitAll()



                        .requestMatchers( "/", "/auth/*", "/auth/login", "/job-posting/*","/job-posting", "job-posting","/register", "/oglas/*", "/korisnik-detalji/*","/users/*").permitAll()
